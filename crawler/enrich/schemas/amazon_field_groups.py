...
_products_description = FieldGroupSpec(  # 结构化特征提取、规格表、使用案例和目标受众推断
    ...
    output_fields=[
        ...
        OutputFieldSpec(name="key_specs_table", field_type="object"),
        OutputFieldSpec(name="use_cases_extracted", field_type="array<string>"),
        OutputFieldSpec(name="target_audience_inferred", field_type="string"),
    ],
    strategy="generative_only",
...
_reviews_identity = FieldGroupSpec(
    ...
    required_source_fields=["reviewer_name", "review_text"],
    output_fields=[
